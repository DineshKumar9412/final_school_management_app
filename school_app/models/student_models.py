...
class StudentClassMapping(Base):
    ...
    school_stream_id:  Mapped[Optional[int]]  = mapped_column(BigInteger, ForeignKey("school_stream.school_stream_id", ondelete="SET NULL", name="fk_class_student_stream"), nullable=True)
