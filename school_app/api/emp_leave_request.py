...
async def list_leave_requests(
    ...
    status:     LeaveStatusEnum | None = Query(None, description="Filter by status: Approved / Rejected / Pending"),
    leave_type: LeaveTypeEnum   | None = Query(None, description="Filter by type: Full / First Half / Second Half"),
