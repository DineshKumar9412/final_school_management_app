...
@school_group_router.post(
    "/create_group",
    summary="Create a new school group",
    responses={
        201: {"content": {"application/json": {"example": {
            "code": 201,
            "message": "School group created successfully.",
            "result": {"school_group_id": 1, "school_id": 1, "group_name": "Primary", "status": "active"}
        }}}},
        409: {"content": {"application/json": {"example": {
            "code": 409,
            "message": "Group name 'Primary' already exists for this school.",
            "result": {}
        }}}},
    },
)
...
@school_group_router.get(
    "/grouplist",
    summary="List all school groups",
    responses={
        200: {"content": {"application/json": {"example": {
            ...
            "result": {
                ...
                "data": [
                    {"school_group_id": 1, "school_id": 1, "group_name": "Primary",   "status": "active"},
                    {"school_group_id": 2, "school_id": 1, "group_name": "Secondary", "status": "active"},
                ]
            }
        }}}},
    },
...
@school_group_router.get(
    "/get_id/{group_id}",
    summary="Get a school group by ID",
    responses={
        200: {"content": {"application/json": {"example": {
            "code": 200,
...
@school_group_router.put(
    ...
    summary="Update a school group",
    responses={
        200: {"content": {"application/json": {"example": {
            "code": 200,
            "message": "School group updated successfully.",
            "result": {"school_group_id": 1, "school_id": 1, "group_name": "Higher Secondary", "status": "active"}
        }}}},
        404: {"content": {"application/json": {"example": {
            "code": 404,
            "message": "School group not found.",
...
@school_group_router.delete(
    ...
    summary="Soft delete a school group and all its children",
    responses={
        200: {"content": {"application/json": {"example": {
            "code": 200,
            "message": "School group and all related records deleted successfully.",
            "result": {"school_group_id": 1}
        }}}},
        404: {"content": {"application/json": {"example": {
            "code": 404,
            "message": "School group not found.",
...
@school_group_router.get(
    "/school-groups/all",
    summary="Dropdown: School Groups",
    responses={
        200: {"content": {"application/json": {"example": {
            "code": 200,
